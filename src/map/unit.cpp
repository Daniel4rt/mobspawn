...
int unit_walktoxy_sub(struct block_list *bl)
{
	...
	nullpo_retr(1, bl);
	// ud = unit_bl2ud(bl); https://github.com/rathena/rathena/pull/5263/commits/6305fc1b9953a837add48acff79a607065e428eb
	// if(ud == NULL) return 0; https://github.com/rathena/rathena/pull/5263/commits/621b44c964b94f6dfa1773e72fa8a79abc75353b
...
static TIMER_FUNC(unit_walktoxy_timer){
	...
	if(i > 0) {
		...
		if(battle_config.official_cell_stack_limit >= 0
			&& map_count_oncell(bl->m, x, y, BL_CHAR|BL_NPC, 1) > (battle_config.official_cell_stack_limit + 1)) {
